...
//>>>>>	��ʾ�����ַ�������ASCII��
void 	LCD_SetTextFont(pChineseFont *fonts);								// �����ı����壬�������ĺ�ASCII����
void  GetGB2312Code ( uint8_t * pBuffer, uint16_t code);				// ��ȡ���ֵĵ����ֿ�����
void  LCD_DisplayChinese (uint16_t x,uint16_t y,uint16_t code);	// ��ʾ��������
...
/*
 * 背光引脚二选一（与 lcd_pwm.h 中 TIM 一致）：
 * 0 = 反客 FK743 默认：PH6 + TIM12_CH1。
 * 1 = 老师/正点原子表：PB5 + TIM3_CH2。
 * 若需用 PB5，可在 Keil 「Options → C/C++ → Define」增加：LCD_BL_YUANZI_WIRING=1
 */
#ifndef LCD_BL_YUANZI_WIRING
#define LCD_BL_YUANZI_WIRING 0
#endif
